...
const bot = new Telegraf("1965069129:AAFO3Om7xiK_BoUHJluELv4vZNY2Xw6PYHQ"); // get token in BotFather Telegram
        ...
        function sendStart(ctx) {
            bot.telegram.sendMessage(ctx.chat.id, "TELEGRAM BOT\n\ni have some download features",
            {
               ...
               inline_keyboard: [
               [{
                 text: 'Owner ♥️', url: 'http://t.me/cyz_chan'
              },
              {
                  text: 'Source Code 💻', url: 'https://github.com/CyzChan/TeleBot'
              }]
            ]
              },
